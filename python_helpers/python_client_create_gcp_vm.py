...
# # Setup Python Virtual ENV and Install Required Packages
# python -m venv .venv
...
def get_image_from_family(project: str, family: str) -> compute_v1.Image:
    ...
    print(f"new image: {newest_image}")
    return newest_image
...
def create_instance(
    ...
    print(f"Creating the {instance_name} instance in {zone} in project {project_id}...")
...
if __name__ == "__main__":
    ...
    try:
        ...
        print(f"gcp project id is {default_project_id}")
        ...
        instance_name = "demo-py-cl-compute-" + uuid.uuid4().hex[:10]
